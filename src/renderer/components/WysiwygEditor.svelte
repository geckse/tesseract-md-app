<script lang="ts">
  ...
  import { isDirty, wordCount, tokenCount, countWords, countTokens, saveRequested, discardRequested, editorMode, syncEditorStoresFromTab, type EditorMode } from '../stores/editor';
